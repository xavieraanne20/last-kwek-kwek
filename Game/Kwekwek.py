...
def game_timebound_mode():
	...
	while game_is_running:
		...
		for key, value in kweks.items() :
			...
			print (key, value.kwek_get_size())
			kplayer = ("player" + str(key) + "score: " +str(value.kwek_get_size()))
			ktext = font2.render(kplayer, True, (255,255,255))
			screen.blit(ktext, (735, 120))

			kplayer1 = ("player" + str(key) + "score: " +str(value.kwek_get_size()))
			ktext1 = font2.render(kplayer1, True, (255,255,255))
			screen.blit(ktext1, (735, 140))

			kplayer2 = ("player" + str(key) + "score: " +str(value.kwek_get_size()))
			ktext2 = font2.render(kplayer2, True, (255,255,255))
			screen.blit(ktext2, (735, 160))
