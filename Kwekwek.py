...
def game_timebound_mode():
	...
	while game_is_running:
		...
		for key,value in kweks.items():
			...
			i += 30
			scores.append((key,value.kwek_get_size()))
			print (key, value.kwek_get_size())
		...
		print (scores)
		first_rank = str(max(scores[0][1],scores[1][1],scores[2][1]))
		
		first_text = font.render(first_rank, True, (255,255,255))
		screen.blit(first_text, (870, 150))
		for event in pygame.event.get():
			if event.type == QUIT:
